...
public final class StringDistanceBuilderExample {
    ...
    public static void main(String []args) throws FileNotFoundException {
        ...
        String []p=list.get(1).split(",");
        String xx=x[0];
        String pp=p[0];
        double c=example00(xx,pp);
        System.out.print(c);
    }
     ...
     * @param s
     */
    public static double example00(String x, String s) {
        ...
        return metric.distance(x, s); // 7.0000
    }
     ...
     * interface.
     */
    public static float example01(String a,String b) {


        StringDistance metric =
                (StringDistance) with(new Levenshtein())
    ...
    public static float example03() {
        ...
        StringDistance metric =
                (StringDistance) with(new EuclideanDistance<String>())
